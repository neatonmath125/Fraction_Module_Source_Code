...
<div style="z-index:-1" id="confetti"></div>
	...
	<div style="margin-left:75px; z-index:-100; margin-top: 0px;" class="stat-levels">
			<span class="progress_text">Reciprical Basics: </span><span id = "progress1" style="color:yellow;" class="progress_text"></span><span id="points_completed1" style="color:black;" class="progress_text"></span>
		<div style="z-index:-100;" class="stat-1 stat-bar">
		  <span class="stat-bar-rating" id = "bar1" role="stat-bar" style="width: 0%;"></span>
		</div>
		<span class="progress_text">Divide to Multiply: </span><span id = "progress2" style="color:yellow;" class="progress_text"></span><span id="points_completed2" style="color:black;" class="progress_text"></span>
		...
		<div class="stat-4 stat-bar">
		  ...
		  <span class="progress_text">Reduce First Then Divide </span><span style="color:yellow;" id = "progress5" class="progress_text"></span><span id="points_completed5" style="color:black;" class="progress_text"></span>
		  <div class="stat-5 stat-bar">
			<span class="stat-bar-rating" id = "bar5" role="stat-bar" style="width: 0%;"></span>
		  </div>
		  <span class="progress_text">Mixed Dividing</span><span style="color:yellow;" id = "progress6" class="progress_text"></span><span id="points_completed6" style="color:black;" class="progress_text"></span>

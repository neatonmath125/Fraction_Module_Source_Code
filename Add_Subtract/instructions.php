...
var completed_list = [total_first, total_second, total_third, total_fourth, total_fifth, total_sixth, total_seventh, total_eigth]
...
<div style="z-index:-1" id="confetti"></div>
	...
	<div style="margin-left:75px; z-index:-100; margin-top: 0px;" class="stat-levels">
			<span class="progress_text">Pieces and Parts: </span><span id = "progress1" style="color:yellow;" class="progress_text"></span><span id="points_completed1" style="color:black;" class="progress_text"></span>
		<div style="z-index:-100;" class="stat-1 stat-bar">
		  <span class="stat-bar-rating" id = "bar1" role="stat-bar" style="width: 0%;"></span>
		</div>
		<span class="progress_text">How Big? A: </span><span id = "progress2" style="color:yellow;" class="progress_text"></span><span id="points_completed2" style="color:black;" class="progress_text"></span>
		<div class="stat-2 stat-bar">
		  <span class="stat-bar-rating" id = "bar2" role="stat-bar" style="width: 0%;"></span>
		</div>
		<span class="progress_text">How Big? B: </span><span id = "progress3" style="color:yellow;" class="progress_text"></span><span id="points_completed3" style="color:black;" class="progress_text"></span>
		<div class="stat-3 stat-bar">
		  <span class="stat-bar-rating" id = "bar3" role="stat-bar" style="width: 0%;"></span>
		</div>
		<span class="progress_text">Step By Step A: </span><span id = "progress4" style="color:yellow;" class="progress_text"></span><span id="points_completed4" style="color:black;" class="progress_text"></span>
		<div class="stat-4 stat-bar">
			<span class="stat-bar-rating" id = "bar4" role="stat-bar" style="width: 0%;"></span>
		  </div>
		  <span class="progress_text">Step By Step B: </span><span style="color:yellow;" id = "progress5" class="progress_text"></span><span id="points_completed5" style="color:black;" class="progress_text"></span>
		  <div class="stat-5 stat-bar">
			<span class="stat-bar-rating" id = "bar5" role="stat-bar" style="width: 0%;"></span>
		  </div>
		  <span class="progress_text">Step By Step C: </span><span style="color:yellow;" id = "progress6" class="progress_text"></span><span id="points_completed6" style="color:black;" class="progress_text"></span>
		  <div class="stat-6 stat-bar">
			<span class="stat-bar-rating" id = "bar6" role="stat-bar" style="width: 0%;"></span>
			</div>
			<span class="progress_text">Mixed Results A: </span><span id = "progress7" style="color:yellow;" class="progress_text"></span><span id="points_completed7" style="color:black;" class="progress_text"></span>
		<div class="stat-7 stat-bar">
			<span class="stat-bar-rating" id = "bar7" role="stat-bar" style="width: 0%;"></span>
		  </div>
		  <span class="progress_text">Mixed Results B: </span><span style="color:yellow;" id = "progress8" class="progress_text"></span><span id="points_completed8" style="color:black;" class="progress_text"></span>

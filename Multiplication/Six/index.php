...
<html>
    ...
    <script async src='./Javascript/workings.js'></script>
    <svg style="position:absolute; margin-top:-100px; margin-left:-10; z-index:-10" version="1.1" class="ship" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path id="spindript" class="ship1" d="M256.9,371h114.2h25.3c0,0,10.9-3.6,9-8.1s-4.5-3.6-10.9,0.9c0,0-6.3,4.5-11.8,2.7
  ...
  <g>
	...
	<h1 id = "total_points2" style="color:white; font-size: 50px; font-weight: normal; margin-top: -50px; font-family: Arial, Helvetica, sans-serif;"><div class = "points_total" style="color:#ffffff; font-size: 60px; text-align: left; padding-left: 75px; margin-top: 75px;">Reduce First Then Multiply</div><div style = "margin-top: -65px; margin-left: 900px; font-weight: normal; font-size: 30px; background-color: rgb(174, 124, 221)" class="directions" onclick="instructions()">Instructions</div></h1>
    <p style="text-align: center; align-content: center; font-size: 25px;"><div id = "5055" style = "background-color: rgb(97, 148, 190)" class="difficulty" onclick="shape1()">Exercise:<br>&#9733</div><div id = "5056" style="background-color: rgb(66, 126, 66)" id = "easy" class="difficulty" onclick="shape2()">Exercise:<br>&#9733&#9733</div><div id = "5056" style="background-color: rgb(133, 131, 64)" id = "easy" class="difficulty" onclick="shape3()">Exercise:<br>&#9733&#9733&#9733</div></p>
